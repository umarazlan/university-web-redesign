...
const StudentLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            login(res.data);
            navigate('/check-merit'); // Redirect students to merit check
        } catch (err) {
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-lg shadow-sm border border-gray-100">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-600">
                        Or <Link to="/register" className="font-medium text-primary hover:text-primary-light">register a new account</Link>
                    </p>
                </div>
                    ...
                    <div className="rounded-md shadow-sm -space-y-px">
                        <div>
                            <input
                                ...
                                placeholder="Email address or CNIC"
                                value={loginId}
